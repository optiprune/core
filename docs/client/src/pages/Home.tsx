  ...
  return <div className="welcome-page">
    <header className="welcome-header">
      ...
      <nav>
        ...
        <a className="skill-link" aria-label="GitHub" href={links.core} target="_blank" rel="noreferrer">
          <img src="https://skillicons.dev/icons?i=github" alt="GitHub" />
        </a>
        <a className="skill-link" aria-label="npm" href={links.npm} target="_blank" rel="noreferrer">
          <img src="https://skillicons.dev/icons?i=npm" alt="npm" />
        </a>
        <a className="skill-link" aria-label="VS Code extension" href={links.vscode} target="_blank" rel="noreferrer">
    ...
    <main className="welcome-main">
      <section className="welcome-hero">
        <div className="welcome-copy">
          <h1>Stop guessing.<br /><span>Start proving.</span></h1>
          <p>OptiPrune finds unreachable files, exports, dependencies, and logic in TypeScript and JavaScript workspaces—then gives you the context to decide what goes.</p>
          <div className="welcome-actions">
            <a className="welcome-primary" href={links.docs}>Read the docs <ArrowRight size={16} /></a>
            <a className="welcome-secondary" href={links.reference}>Search the reference <ArrowUpRight size={15} /></a>
          </div>
        ...
        <div className="welcome-art">
          <div className="welcome-art-visual">
            ...
            <img className="welcome-art-animation" src="/optiprune-animation.svg" alt="OptiPrune analyzer animation" />
          </div>
    ...
    <footer className="welcome-footer">
      <span><Terminal size={14} /> npm install --save-dev @optiprune/cli</span>
