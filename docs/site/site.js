...
async function blogPage() {
  ...
  return layout(
    posts.length
      ...
      : `<div class="empty">No public posts yet. Publish a KV record with <code>show_on_website: true</code> to make it appear here.</div>`,
    "Journal / Updates",
    "The OptiPrune blog.",
...
document.querySelector("[data-theme-toggle]").onclick = () => {
  document.documentElement.dataset.theme =
    document.documentElement.dataset.theme === "mono" ? "" : "mono";
};
fetch("/plugins.json")
  .then((r) => r.json())
  .then((items) => {
