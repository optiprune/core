...
export const ReactNativePlugin: AnalyzerPlugin = {
  ...
  detect: async (adapter) => {
    ...
    if (pkg) {
      ...
      if (REACT_NATIVE_PACKAGES.some((p) => p in allDeps)) {
        return true;
      }
    }
