...
export const forEachPassThroughReExport = (
  importMaps: ImportMaps,
  callback: PassThroughReExportCallback,
): boolean => {
...
export const forEachAliasReExport = (
  importMaps: ImportMaps,
  callback: AliasReExportCallback,
): boolean => {
...
export const forEachNamespaceReExport = (
  importMaps: ImportMaps,
  callback: NamespaceReExportCallback,
): boolean => {
...
export const getStarReExportSources = (importMaps: ImportMaps) =>
  importMaps.reExport.get(IMPORT_STAR);
