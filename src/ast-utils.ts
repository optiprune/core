export const t = {
  ...
  isMemberExpression: (
    n: unknown,
  ): n is { type: "MemberExpression"; object: any; property: any; computed: boolean } =>
  ...
  isFunctionDeclaration: (
    n: unknown,
  ): n is { type: "FunctionDeclaration"; id: { name: string } | null; params: any[]; body: any } =>
    !!n && typeof n === "object" && (n as any).type === "FunctionDeclaration",
  isExportNamedDeclaration: (
    n: unknown,
  ): n is { type: "ExportNamedDeclaration"; declaration: any; specifiers: any[] } =>
    !!n && typeof n === "object" && (n as any).type === "ExportNamedDeclaration",
  isImportDeclaration: (
    n: unknown,
  ): n is { type: "ImportDeclaration"; source: { value: string }; specifiers: any[] } =>
    !!n && typeof n === "object" && (n as any).type === "ImportDeclaration",
  isObjectProperty: (
    n: unknown,
  ): n is { type: "Property"; key: any; value: any; computed: boolean } =>
    !!n &&
    typeof n === "object" &&
    ((n as any).type === "Property" || (n as any).type === "ObjectProperty"),
  isObjectMethod: (n: unknown): n is { type: "ObjectMethod"; key: any } =>
    !!n && typeof n === "object" && (n as any).type === "ObjectMethod",
  isTSInterfaceDeclaration: (
    n: unknown,
  ): n is { type: "TSInterfaceDeclaration"; id: { name: string } } =>
    !!n && typeof n === "object" && (n as any).type === "TSInterfaceDeclaration",
  isTSTypeAliasDeclaration: (
    n: unknown,
  ): n is { type: "TSTypeAliasDeclaration"; id: { name: string } } =>
  ...
  isClassDeclaration: (
    n: unknown,
  ): n is { type: "ClassDeclaration"; id: { name: string } | null } =>
  ...
  isClassProperty: (n: unknown): n is { type: "ClassProperty"; key: any } =>
    !!n &&
    typeof n === "object" &&
    ((n as any).type === "ClassProperty" || (n as any).type === "PropertyDefinition"),
  isExportDefaultDeclaration: (
    n: unknown,
  ): n is { type: "ExportDefaultDeclaration"; declaration: any } =>
    !!n && typeof n === "object" && (n as any).type === "ExportDefaultDeclaration",
  isFunctionExpression: (
    n: unknown,
  ): n is { type: "FunctionExpression"; id: { name: string } | null; params: any[]; body: any } =>
  ...
  isJSXMemberExpression: (
    n: unknown,
  ): n is { type: "JSXMemberExpression"; object: any; property: any } =>
  ...
  isTemplateLiteral: (
    n: unknown,
  ): n is { type: "TemplateLiteral"; quasis: any[]; expressions: any[] } =>
  ...
  isVariableDeclaration: (
    n: unknown,
  ): n is { type: "VariableDeclaration"; declarations: any[]; kind: string } =>
  ...
  isAssignmentExpression: (
    n: unknown,
  ): n is { type: "AssignmentExpression"; left: any; right: any } =>
    !!n && typeof n === "object" && (n as any).type === "AssignmentExpression",
  isArrowFunctionExpression: (
    n: unknown,
  ): n is { type: "ArrowFunctionExpression"; params: any[]; body: any } =>
  ...
  isTaggedTemplateExpression: (
    n: unknown,
  ): n is { type: "TaggedTemplateExpression"; tag: any; quasi: any } =>
    !!n && typeof n === "object" && (n as any).type === "TaggedTemplateExpression",
  isTSAsExpression: (
    n: unknown,
  ): n is { type: "TSAsExpression"; expression: any; typeAnnotation: any } =>
    !!n && typeof n === "object" && (n as any).type === "TSAsExpression",
  isTSTypeAssertion: (
    n: unknown,
  ): n is { type: "TSTypeAssertion"; expression: any; typeAnnotation: any } =>
    !!n && typeof n === "object" && (n as any).type === "TSTypeAssertion",
  isTSNonNullExpression: (n: unknown): n is { type: "TSNonNullExpression"; expression: any } =>
    !!n && typeof n === "object" && (n as any).type === "TSNonNullExpression",
  isMetaProperty: (n: unknown): n is { type: "MetaProperty"; meta: any; property: any } =>
    !!n && typeof n === "object" && (n as any).type === "MetaProperty",
  isExportAllDeclaration: (
    n: unknown,
  ): n is { type: "ExportAllDeclaration"; source: { value: string } } =>
    !!n && typeof n === "object" && (n as any).type === "ExportAllDeclaration",
  isExportDeclaration: (
    n: unknown,
  ): n is { type: "ExportDeclaration"; source: { value: string } } =>
    !!n && typeof n === "object" && (n as any).type === "ExportDeclaration",
  isImportExpression: (n: unknown): n is { type: "ImportExpression"; source: any } =>
    !!n && typeof n === "object" && (n as any).type === "ImportExpression",
};
