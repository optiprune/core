export const t = {
  ...
  isTaggedTemplateExpression: (n: unknown): n is { type: "TaggedTemplateExpression"; tag: any; quasi: any } =>
    !!n && typeof n === 'object' && (n as any).type === 'TaggedTemplateExpression',
  isTSAsExpression: (n: unknown): n is { type: "TSAsExpression"; expression: any; typeAnnotation: any } =>
    !!n && typeof n === 'object' && (n as any).type === 'TSAsExpression',
  isTSTypeAssertion: (n: unknown): n is { type: "TSTypeAssertion"; expression: any; typeAnnotation: any } =>
  ...
  isExportAllDeclaration: (n: unknown): n is { type: "ExportAllDeclaration"; source: { value: string } } =>
    !!n && typeof n === 'object' && (n as any).type === 'ExportAllDeclaration',
  isExportDeclaration: (n: unknown): n is { type: "ExportDeclaration"; source: { value: string } } =>
