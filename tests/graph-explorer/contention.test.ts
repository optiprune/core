  ...
  graph.set(filePath3, {
    ...
    imports: {
      ...
      internal: new Map([
        [
          filePath1,
          { ...baseImportMaps, reExport: new Map([["identifier", new Set([filePath3])]]) },
        ],
      ]),
    },
  });
  ...
  graph.set(filePath4, {
    ...
    imports: {
      ...
      internal: new Map([
        [
          filePath2,
          { ...baseImportMaps, reExport: new Map([["identifier", new Set([filePath4])]]) },
        ],
        [
          filePath3,
          { ...baseImportMaps, reExport: new Map([["identifier", new Set([filePath4])]]) },
...
test("should detect conflict through star re-exports chain", () => {
  ...
  graph.set(filePath2, {
    ...
    imports: {
      ...baseFileNode.imports,
      internal: new Map([
        [filePath3, { ...baseImportMaps, reExport: new Map([["*", new Set([filePath2])]]) }],
      ]),
    },
  });
  ...
  graph.set(filePath1, {
    ...
    imports: {
      ...baseFileNode.imports,
      internal: new Map([
        [filePath2, { ...baseImportMaps, reExport: new Map([["*", new Set([filePath1])]]) }],
      ]),
    },
  });
