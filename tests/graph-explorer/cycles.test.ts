...
import { IMPORT_FLAGS } from "../../src/constants.js";
...
test("should detect simple circular dependency (A -> B -> A)", () => {
  ...
  graph.set(filePath2, {
    ...
    imports: {
      ...
      imports: new Set([
        { ...baseImport, specifier: "./module-1", filePath: filePath1, identifier: "bar" },
      ]),
    },
  });
...
test("should detect longer circular dependency (A -> B -> C -> A)", () => {
  ...
  graph.set(filePath2, {
    ...
    imports: {
      ...
      imports: new Set([
        { ...baseImport, specifier: "./module-3", filePath: filePath3, identifier: "bar" },
      ]),
    },
  });
  ...
  graph.set(filePath3, {
    ...
    imports: {
      ...
      internal: new Map([[filePath1, { ...baseImportMaps }]]),
      imports: new Set([
        { ...baseImport, specifier: "./module-1", filePath: filePath1, identifier: "baz" },
      ]),
    },
  });
...
test("should skip type-only imports", () => {
  ...
  graph.set(filePath2, {
    ...
    imports: {
      ...
      internal: new Map([[filePath1, { ...baseImportMaps }]]),
      imports: new Set([
        { ...baseImport, specifier: "./module-1", identifier: "Type", isTypeOnly: true },
      ]),
    },
  });
...
test("should respect maxDepth", () => {
  ...
  graph.set(filePath3, {
    ...
    imports: {
      ...
      imports: new Set([
        { ...baseImport, specifier: "./module-4", filePath: filePath4, identifier: "baz" },
      ]),
    },
  });
  ...
  graph.set(filePath4, {
    ...
    imports: {
      ...
      internal: new Map([[filePath1, { ...baseImportMaps }]]),
      imports: new Set([
        { ...baseImport, specifier: "./module-1", filePath: filePath1, identifier: "qux" },
      ]),
    },
  });
...
test("findAllCycles: detects multiple independent cycles sharing a node", () => {
  ...
  graph.set(
    filePath1,
    node(runtimeImport(filePath2, "./module-2"), runtimeImport(filePath3, "./module-3")),
  );
      ...
      imports: new Set([
        {
          ...
          specifier: "./module-1",
          filePath: filePath1,
          modifiers: IMPORT_FLAGS.DYNAMIC,
        },
      ]),
    },
  });
