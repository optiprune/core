...
import {
  ...
  baseImportMaps,
  getBaseImport,
} from "../helpers/baseNodeObjects.js";
  ...
  graph.set(filePath2, {
    ...
    imports: {
      ...
      internal: new Map([
        [
          filePath1,
          { ...baseImportMaps, imported: new Map([["identifier", new Set([filePath2])]]) },
        ],
      ]),
  ...
  graph.set(filePath3, {
    ...
    imports: {
      ...
      internal: new Map([
        [
          filePath2,
          { ...baseImportMaps, imported: new Map([["identifier", new Set([filePath3])]]) },
        ],
      ]),
