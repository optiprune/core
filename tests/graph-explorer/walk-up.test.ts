  ...
  graph.set(filePath1, {
    ...
    imports: {
      ...
      internal: new Map([
        [
          filePath2,
          { ...baseImportMaps, reExport: new Map([["identifier", new Set([filePath1])]]) },
        ],
      ]),
    },
  });
    ...
    imports: {
      ...
      internal: new Map([
        [
          ...
          {
            ...baseImportMaps,
            reExportAs: new Map([["alias", new Map([["identifier", new Set([filePath1])]])]]),
          },
        ],
      ]),
    },
...
test("should follow namespace re-export", () => {
  ...
  graph.set(filePath1, {
    ...
    imports: {
      ...baseFileNode.imports,
      internal: new Map([
        [filePath2, { ...baseImportMaps, reExportNs: new Map([["NS", new Set([filePath1])]]) }],
      ]),
    },
  });
  ...
  graph.set(filePath1, {
    ...
    imports: {
      ...
      internal: new Map([
        [
          filePath2,
          { ...baseImportMaps, reExport: new Map([[IMPORT_STAR, new Set([filePath1])]]) },
        ],
      ]),
    },
  });
  ...
  graph.set(filePath2, {
    ...
    imports: {
      ...
      internal: new Map([
        [
          filePath3,
          { ...baseImportMaps, reExport: new Map([["identifier", new Set([filePath2])]]) },
        ],
      ]),
    },
  });
